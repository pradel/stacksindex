...
Check out [`examples/dex-alex`](https://github.com/pradel/stacksindex/tree/main/examples/dex-alex) for a complete working example indexing the ALEX DEX pool contracts with relational tables and typed read-only calls.
